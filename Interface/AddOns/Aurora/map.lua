...
w:SetScript("OnEvent", function(self, event, ...)
	if event == "PLAYER_ENTERING_WORLD" then
		...
		local cond = false
		BlackoutWorld:Hide()
		BlackoutWorld.Show = F.dummy
		BlackoutWorld.Hide = F.dummy
		...
		WorldMapBlobFrame.Hide = F.dummy
...
WorldMapFrameSizeUpButton.SetFrameStrata = F.dummy
WorldMapFrameSizeDownButton:SetFrameStrata("HIGH")
WorldMapFrameSizeDownButton.SetFrameStrata = F.dummy
WorldMapFrameCloseButton:SetFrameStrata("HIGH")
WorldMapFrameCloseButton.SetFrameStrata = F.dummy
WorldMapLevelUpButton:SetFrameStrata("HIGH")
WorldMapLevelUpButton.SetFrameStrata = F.dummy
WorldMapLevelDownButton:SetFrameStrata("HIGH")
WorldMapLevelDownButton.SetFrameStrata = F.dummy
...
local function SmallSkin()
	...
	WorldMapLevelDropDown.Show = F.dummy
...
local function QuestSkin()
	...
	if not WorldMapQuestDetailScrollFrame.backdrop then
		...
		F.CreateBD(WorldMapQuestDetailScrollFrame.backdrop)
	...
	if not WorldMapQuestRewardScrollFrame.backdrop then
		...
		F.CreateBD(WorldMapQuestRewardScrollFrame.backdrop)
	...
	if not WorldMapQuestScrollFrame.backdrop then
		...
		F.CreateBD(WorldMapQuestScrollFrame.backdrop)
