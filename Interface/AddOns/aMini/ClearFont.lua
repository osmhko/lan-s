...
-- 金幣、堆疊、按鍵綁定等字體
	local CLEAR_FONT_NUMBER = CLEAR_FONT_BASE .. "ZYKai_T.TTF";--"FRIZQT__.TTF";
-- 生命條、經驗條上的字體
	local CLEAR_FONT_EXP = CLEAR_FONT_BASE .. "ZYKai_T.TTF";--"ARIALN.TTF";
-- 任務說明和書信、石碑的正文字體
	local CLEAR_FONT_QUEST = CLEAR_FONT_BASE .. "ZYKai_T.TTF";--"bLEI00D.TTF";
-- 戰鬥傷害數值提示
	local CLEAR_FONT_DAMAGE = CLEAR_FONT_BASE .. "ZYKai_T.TTF";--"bKAI00M.TTF";
-- 遊戲介面中的主要字體
	local CLEAR_FONT = CLEAR_FONT_BASE .. "ZYKai_T.TTF";--"bLEI00D.TTF";
-- 物品、技能的說明字體
	local CLEAR_FONT_ITEM = CLEAR_FONT_BASE .. "ZYKai_T.TTF";--"bHEI00M.TTF";
-- 聊天字體
	local CLEAR_FONT_CHAT = CLEAR_FONT_BASE .. "ZYKai_T.TTF";--"bHEI01B.TTF";
