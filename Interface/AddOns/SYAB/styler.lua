...
function Style(self, totem, flyout)
	...
	if Count then
		...
		Count:SetPoint("BOTTOMRIGHT", 0, B.Scale(2))
		-- Count:SetFont(C.font, B.Scale(10), "OUTLINE")
		Count:SetFont(C.font, B.mult*10, "OUTLINE")
	end
	...
	if HotKey then
		...
		-- HotKey:SetFont(C.font, B.Scale(10), "OUTLINE")
		HotKey:SetFont(C.font, B.mult*10, "OUTLINE")
		HotKey:SetShadowColor(0, 0, 0, 0.3)
		HotKey.ClearAllPoints = B.dummy
		HotKey.SetPoint = B.dummy
