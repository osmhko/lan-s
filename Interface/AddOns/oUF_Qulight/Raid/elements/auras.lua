...
local glowBorder = {
    ...
    edgeFile = [=[Interface\AddOns\oUF_Qulight\Media\glowTex.tga]=], edgeSize = 5,
...
local CreateAuraIcon = function(auras)
    ...
    count:SetFont(Qulight["media"].font, Qulight["raidframes"].fontsizeEdge, Qulight["raidframes"].outline)
    ...
    remaining:SetFont(Qulight["media"].font, Qulight["raidframes"].fontsizeEdge, Qulight["raidframes"].outline)
